...
* If all players but one have resigned, the player that's left wins. If some players have resigned but more than two players remain, the game continues as if the resigned players are left, and the resigned players' moves are filled in with pass moves.
----
